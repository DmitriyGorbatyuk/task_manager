...
public class Attributes {
    ...
    public static final String REGISTRATION_USER_BEAN_VALIDATOR = "registrationUserBeanValidator";
    public static final String LOGIN_USER_BEAN_VALIDATOR = "loginUserBeanValidator";
    public static final String REQUEST_TO_REGISTRATION_BEAN_CONVERTER = "requestToRegistrationBeanConverter";
    public static final String REQUEST_TO_LOGIN_BEAN_CONVERTER = "requestToLoginBeanConverter";
    public static final String REGISTRATION_BEAN_TO_USER_CONVERTER = "registrationBeanToUserConverter";
    ...
    public static final String REQUEST_TO_CATEGORY_CONVERTER = "requestToCategoryConverter";
